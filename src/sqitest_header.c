...
const FLASHER_VERSION_T flasher_version =
{
	...
	.pucBuffer_Data = __BUFFER_START__ + sizeof(NETX_CONSOLEAPP_PARAMETER_T) + sizeof(tFlasherInputParameter),
	.pucBuffer_End = __BUFFER_END__,

	.aulChiptyp =
	{
		FLASHER_CHIPTYP0_NETX4000_RELAXED,

		0
	},
	.aulIf =
	{
		FLASHER_IF0_NETX4000_RELAXED_PFSRAM |
		FLASHER_IF0_NETX4000_RELAXED_SPI,
